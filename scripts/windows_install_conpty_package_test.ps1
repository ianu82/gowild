...
if ($installerSource -notlike "*https://github.com/ianu82/gowild/releases/latest/download/latest.json*") {
    throw "installer is missing the GoWild-owned stable manifest default"
}
