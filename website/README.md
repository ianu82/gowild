# Frozen imported website snapshot
...
GoWild-owned content in a separately reviewed change after its hosting,
artifacts, signing, manifests, and install path exist.

No file or script here authorizes interaction with the source-provenance
project. All GoWild development, automation, packages, and publishing belong
only to `ianu82/gowild`.
