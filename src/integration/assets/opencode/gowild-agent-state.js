...
// GOWILD_INTEGRATION_ID=opencode
// GOWILD_INTEGRATION_VERSION=10

import net from "node:net";

const SOURCE = "gowild:opencode";
...
export const GoWildAgentStatePlugin = async () => {
  if (
    process.env.GOWILD_ENV !== "1" ||
    !process.env.GOWILD_SOCKET_PATH ||
    !process.env.GOWILD_PANE_ID
  ) {
    return {};
  }
